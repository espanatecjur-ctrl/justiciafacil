// ============================================================
// RecorridoActorUCP · Recorrido de pre-dictamen para la posición "Actor"
// ------------------------------------------------------------
...
export interface ResultadosActorUCP {
...
export function RecorridoActorUCP({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Robot de búsqueda jurídica — Boletín judicial (autollena el dictamen) */}
      <div className="rounded-xl border border-border bg-card p-4">
        <p className="mb-2 flex items-center gap-2 text-xs text-muted-foreground"><Search className="h-4 w-4" /> Robot de búsqueda jurídica · Boletín judicial</p>
        <BuscadorBoletin
          expedienteInicial={d.expediente}
          estadoInicial={estadoRobot}
          onDatosBoletin={(b) => setD((p) => ({
            ...p,
            expediente: p.expediente || b.expediente || p.expediente,
            juzgado: p.juzgado || b.juzgado || p.juzgado,
            deudor: p.deudor || b.demandado || p.deudor,
            quienCede: p.quienCede || b.actor || p.quienCede,
          }))}
        />
      </div>
