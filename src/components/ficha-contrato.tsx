...
export function FichaContrato({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/40 p-4 sm:p-8" onClick={onClose}>
      <div
        className="w-full max-w-2xl rounded-lg border border-border bg-white shadow-xl"
        ...
        <div className="max-h-[70vh] space-y-3 overflow-y-auto p-4">
          ...
          {t(c.cuerpo) && (
            <Seccion titulo="Documento generado">
              <pre className="max-h-64 overflow-auto whitespace-pre-wrap rounded-md border border-border bg-muted/30 p-3 font-sans text-xs leading-relaxed">
                {c.cuerpo}
              </pre>
            </Seccion>
          )}
